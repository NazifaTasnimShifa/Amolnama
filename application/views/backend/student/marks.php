                ...
                <table class="table table-bordered table-hover table-striped" >
                    <thead>
                        <tr>
                            ...
                            <td><?php echo ('Mark Obtained');?> CT: (Out of 20) Setmester Final: (Out of 72)</td>
                            <td><?php echo ('Grades');?> (Grades for Final Result Only)</td>
                    ...
                    <tbody>
						...
						foreach($students as $row):
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                     <?php $grade = $this->crud_model->get_grade($row2['mark_obtained']);
                                           echo $grade['name'];?>
