...
<div class="panel panel-primary" style="background-color:rgba(255, 255, 255, 0);border-color: rgba(235, 235, 235, 0.14); width: 352px;">
    <div class="panel-heading" style="background-color:rgba(255, 255, 255, 0.16);border-color: rgba(204, 204, 204, 0.08);">
        <div class="panel-title">Quick Access to accounts</div>
        ...
        <table class="table table-bordered table-hover table-responsive">
            ...
            <tbody>
                <tr>
                    ...
                    <td>123456</td>
                    <td>
                        <i class="entypo-target icon-hover tooltip-default" onclick="copy('admin@admin.com' , '123456')"
                            data-toggle="tooltip" data-placement="top" title="" data-original-title="copy"></i>
                    </td>
                </tr>
                <tr>
                    <td>Teacher</td>
                    <td>almamun@teacher.com</td>
                    <td>123456</td>
                    <td>
                        <i class="entypo-target icon-hover tooltip-default" onclick="copy('almamun@teacher.com' , '123456')"
                             data-toggle="tooltip" data-placement="top" title="" data-original-title="copy"></i>
                    </td>
                </tr>
                <tr>
                    <td>Student</td>
                    <td>nazifatasnimshifa@gmail.com</td>
                    <td>123456</td>
                    <td>
                        <i class="entypo-target icon-hover tooltip-default" onclick="copy('nazifatasnimshifa@gmail.com' , '123456')"
                             data-toggle="tooltip" data-placement="top" title="" data-original-title="copy"></i>
                    </td>
                </tr>
            </tbody>
